  ...
  return (
    <>
    {
         userdetail.length > 0 && userdetail.map((el) =>{
          return  <Box className='userprofile' border="1px solid red" height={"80vh"} width="95vw"  m="auto" display="flex" 
      justifyContent={"space-around"}  gap="10px" mt="10" p="10" boxShadow={"lg"} fontFamily="Playfair">
        ...
        <Box className='user-image'  width={{ base: "60%", md: "90v%", lg:"100%" }}  >
         ...
         <Box className='Address-Section' width={{ base: "40vw", md: "60vw", lg:"60vw" }} height="50vh" display={"flex"} justifyContent="space-evenly">
             ...
             <Text fontSize={{ base: "1.2rem", md: "1.5rem", lg: "2rem" }} textAlign="start" mt="5">  <span style={{fontWeight:"600" }}>Name: </span> {el.name}</Text>
              <Text  fontSize={{ base: "1.2rem", md: "1.5rem", lg: "2rem" }} textAlign="start"  mt="5"><span style={{fontWeight:"600" }}>Age: </span>  23  </Text>
              <Text  fontSize={{ base: "1.2rem", md: "1.5rem", lg: "2rem" }} textAlign="start"  mt="5"> <span style={{fontWeight:"600" }}>Gender: </span> Male </Text>
             </Box>

             <Box   height={{ base: "35vh", md: "30vh", lg:"30vh" }}  width={{ base: "50vw", md: "40vw", lg:"30vw" }}  m="auto" p="5">
              <Text fontSize={{ base: "1.2rem", md: "1.5rem", lg: "2rem" }} textAlign="start"  mt="5"> <span style={{fontWeight:"600" }}>Address </span> :- {el.Address}  </Text>
              <Text fontSize={{ base: "1.2rem", md: "1.5rem", lg: "2rem" }}   textAlign="start" mt="5"> <span style={{fontWeight:"600" }}>Mobile</span>: - {el.PhNumber} </Text>
             </Box>
